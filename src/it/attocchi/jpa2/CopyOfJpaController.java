 ...
 */
public class CopyOfJpaController implements Serializable {
	...
	protected static final Logger logger = Logger.getLogger(CopyOfJpaController.class.getName());
	...
	public CopyOfJpaController(EntityManagerFactory emf) {
		this();
	...
	public CopyOfJpaController(String persistenceUnit) {
		this();
	...
	public CopyOfJpaController(String persistenceUnit, Map<String, String> dbConf) {
	 ...
	 * @param aController
	 */
	public static void callCloseEmf(CopyOfJpaController aController) {
		if (aController != null) {
			aController.closeEmAndEmf();
		}
	}

	public static void callRollback(CopyOfJpaController aController) {
		if (aController != null) {
	...
	public static <T extends Serializable> List<T> callFind(EntityManagerFactory emf, Class<T> clazz, JPAEntityFilter<T> filter) throws Exception {
		...
		CopyOfJpaController controller = null;
		try {
			controller = new CopyOfJpaController(emf);
			res = controller.findBy(clazz, filter);
		} catch (Exception ex) {
			logger.error("find", ex);
			throw ex;
		} finally {
			CopyOfJpaController.callCloseEmf(controller);
		}
	...
	public static <T extends Serializable> List<T> callFindPU(String persistenceUnit, Class<T> clazz, JPAEntityFilter<T> filter) throws Exception {
		...
		CopyOfJpaController controller = null;
		try {
			controller = new CopyOfJpaController(persistenceUnit);
			res = controller.findBy(clazz, filter);
		} catch (Exception ex) {
			logger.error("find", ex);
			throw ex;
