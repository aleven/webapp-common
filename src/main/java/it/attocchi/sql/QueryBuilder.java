...
//		equalBulder.append(")");
	...
	public static String likeSimple(String campo, String semeRicerca) {
		...
		if (semeRicerca.startsWith(QueryBuilder.RICERCA_STRING_CHAR) && semeRicerca.endsWith(QueryBuilder.RICERCA_STRING_CHAR)) {
			/* CASO "ciao" */
			semeRicerca = org.apache.commons.lang3.StringUtils.removeStart(semeRicerca, QueryBuilder.RICERCA_STRING_CHAR);
			semeRicerca = org.apache.commons.lang3.StringUtils.removeEnd(semeRicerca, QueryBuilder.RICERCA_STRING_CHAR);

			res.append(campo + " = '" + encodeStringSQL(semeRicerca) + "'");
		} else if (semeRicerca.endsWith(QueryBuilder.RICERCA_JOLLY_CHAR)) {
			/* CASO ciao* */
			semeRicerca = semeRicerca.replace(QueryBuilder.RICERCA_JOLLY_CHAR, "");

			res.append(campo + " LIKE '" + encodeStringSQL(semeRicerca) + "%'");
		} else if (semeRicerca.startsWith(QueryBuilder.RICERCA_JOLLY_CHAR)) {
			/* CASO *ciao */
			semeRicerca = semeRicerca.replace(QueryBuilder.RICERCA_JOLLY_CHAR, "");
	...
	public static String buildUserCommandSearch(String semeRicerca, String fromField, String toField) {
		...
		if (semeRicerca.toUpperCase().startsWith(PREFIX_FROM)) {
			res.append(likeSimple(fromField, org.apache.commons.lang3.StringUtils.removeStart(semeRicerca, PREFIX_FROM)));
		} else if (semeRicerca.toUpperCase().startsWith(PREFIX_TO)) {
			res.append(likeSimple(toField, org.apache.commons.lang3.StringUtils.removeStart(semeRicerca, PREFIX_TO)));
		}
