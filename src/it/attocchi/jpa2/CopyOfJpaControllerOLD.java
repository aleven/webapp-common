 ...
 */
public class CopyOfJpaControllerOLD implements Serializable {
	...
	public CopyOfJpaControllerOLD(EntityManagerFactory emf) {
		this();
	...
	public CopyOfJpaControllerOLD(String persistenceUnit) {
		this();
		this.persistenceUnit = persistenceUnit;
		// passedEmf = false;
	}

	public CopyOfJpaControllerOLD(String persistenceUnit, Map<String, String> dbConf) {
	...
	private void assegnaNumero() {
		...
		CopyOfJpaControllerOLD.Numero++;

		this.numero = CopyOfJpaControllerOLD.Numero;
	...
	public static void close(CopyOfJpaControllerOLD istance) {
		if (istance != null) {
			istance.closeEmf();
		}
	}
	 ...
	 * @param aController
	 */
	public static void callCloseEmf(CopyOfJpaControllerOLD aController) {
		if (aController != null) {
